...
***Finite State Automata Theory** **->** Every computation is described by a path traversing a graph. This path traverses a graph representing some finite state machine.
